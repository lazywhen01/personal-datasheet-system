	...
	<div class="sidebar-inner px-4 pt-3">
		<div class="user-card d-flex d-md-none align-items-center justify-content-between justify-content-md-center pb-4">
			<div class="d-flex align-items-center">
				<div class="avatar-lg me-4">
					<img src="{{ asset('img/team/user-profile.png')  }}" class="card-img-top rounded-circle border-white" alt="Default User Profile">
				</div>
				<div class="d-block">
		...
		<ul class="nav flex-column pt-3 pt-md-0">
			...
			<li class="nav-item {{ request()->routeIs('cprs.*') ? 'active' : '' }}">
				<span class="nav-link collapsed d-flex justify-content-between align-items-center" data-bs-toggle="collapse" data-bs-target="#submenu-cprs" aria-expanded="{{ request()->routeIs('cprs.*') ? 'true' : 'false' }}">
					<span>
						<span class="sidebar-icon">
				...
				<div class="multi-level collapse {{ request()->routeIs('cprs.forms') ? 'show' : '' }}" role="list" id="submenu-cprs" aria-expanded="true">
