<div>
    {{-- modal --}}
    <div class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" id="{{ $modalId }}" tabindex="-1"
            ...
            <div class="modal-content">
                ...
                @if ($type === 'delete')
                    <div class="modal-header">
                        <h5 style="font-style: bold" class="modal-title">Delete Confirmation?</h5>
                        <span class="pull-right">
                            <img class="spinner" src="{{ asset('img/spinner.gif') }}">
                        </span>
                    </div>
                    <div class="modal-body">
                        <p>Are you sure to delete this {{ $label }}?</p>
                    </div>
                    <div class="modal-footer">
                        <button id="{{ $buttonId }}" class="btn btn-danger"> Delete </button>
                        <button id="close-button" data-bs-dismiss="modal" class="btn btn-info">Close </button>
                ...
                @if ($type === 'activate')
                    ...
                    <div class="modal-footer">
                        <button id="confirm-activate" class="btn btn-info">
                            Activate </button>
                        <button id="close-button" data-bs-dismiss="modal" class="btn btn-danger"> Close </button>
                    </div>
                @endif
                ...
                @if ($type === 'deactivate')
                    ...
                    <div class="modal-body">
                        <p>Are you sure to deactivate this {{ $label }}?</p>
                    </div>
                    <div class="modal-footer">
